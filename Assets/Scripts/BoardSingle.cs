...
public class BoardSingle : MonoBehaviour
{
    public Tilemap tilemap { get; private set; }
    public PieceSingle activePiece { get; private set; }
    public PieceSingle nextPiece { get; private set; }
    public PieceSingle nextPiece2 { get; private set; }
    public PieceSingle nextPiece3 { get; private set; }
    public PieceSingle nextPiece4 { get; private set; }
    public PieceSingle nextPiece5 { get; private set; }
    public PieceSingle savedPiece { get; private set; }
    ...
    private void Awake()
    {
        ...
        activePiece = GetComponentInChildren<PieceSingle>();

        nextPiece = gameObject.AddComponent<PieceSingle>();
        nextPiece.enabled = false;

        nextPiece2 = gameObject.AddComponent<PieceSingle>();
        nextPiece2.enabled = false;

        nextPiece3 = gameObject.AddComponent<PieceSingle>();
        nextPiece3.enabled = false;

        nextPiece4 = gameObject.AddComponent<PieceSingle>();
        nextPiece4.enabled = false;

        nextPiece5 = gameObject.AddComponent<PieceSingle>();
        nextPiece5.enabled = false;

        savedPiece = gameObject.AddComponent<PieceSingle>();
    ...
    public void Set(PieceSingle piece)
    {
    ...
    public void Clear(PieceSingle piece)
    {
        for (int i = 0; i < piece.cells.Length; i++)
        {
            Vector3Int tilePosition = piece.cells[i] + piece.position;
    ...
    public bool IsValidPosition(PieceSingle piece, Vector3Int position)
    {
