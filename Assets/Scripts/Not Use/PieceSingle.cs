...
public class PieceSingle : MonoBehaviour
{
    public BoardSingle board { get; private set; }
    ...
    public void Initialize(BoardSingle board, Vector3Int position, TetrominoData data)
    {
        this.data = data;
        this.board = board;
